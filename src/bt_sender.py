...
async def repeated_data_send():
    ...
    async def send_arr(arr):
        ...
        while start_index < NUM_LEDS:
            ...
            outarr = [start_index] + [x for tup in arr[start_index:start_index + sent_arr_len] for x in tup]
    ...
    async with BleakClient(device, disconnected_callback=handle_disconnect) as client:
        ...
        i = 0
        while True:
            await send_arr(random.choices(COLORS, k=NUM_LEDS))
